...
import Leaderboard from "@/app/(root)/Leaderboard/page";
...
export const Logo = () => {
  return (
    ...
    >
      ...
      >
        <p className="text-2xl "> Bloodline 🩸 </p>
      </motion.span>
    </a>
  );
};
    ...
    <div className="flex flex-1">
      <div className="flex h-full w-full flex-1 flex-col gap-2 rounded-tl-2xl border border-neutral-200 bg-white p-2 md:p-10 dark:border-neutral-700 dark:bg-neutral-900">
        ...
        <div className="flex flex-1 gap-2">
          <div className="h-1/2 p-3 w-full rounded-lg bg-gray-100 dark:bg-neutral-800">
            <PlayerList isShortList={true} />
            <span className="text-blue-500 cursor-pointer text-sm italic text-center">
